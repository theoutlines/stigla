...
ETA **≥ `kFarEtaMinutes` (= 90)** показывается **временем прибытия** (`02:45`,
24ч, формат по локали приложения), а не минутами — «158 min» нечитаемо. Порог 90
— именованная константа с комментарием (`core/eta_format.dart → etaLabel`).
